            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="password" type="password" class="border border-gray-400 p-2 w-full @error('password') text-red-500 @enderror" name="password" required autocomplete="current-password">
